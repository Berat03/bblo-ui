...
export function Charts() {
    return (
        <div className=' chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-4'>
            ...
            <div className='grid w-full flex-1 gap-4 lg:max-w-[20rem]'>
                <Card className='max-w-xs' x-chunk='charts-01-chunk-2'>
                    <CardHeader>
                        ...
                        <CardDescription>
                            You averaged more steps a day this year than last
                            year.
                        </CardDescription>
                    </CardHeader>
            ...
            <div className='grid w-full flex-1 gap-4'>
                ...
                <Card className='max-w-xs' x-chunk='charts-01-chunk-6'>
                    <CardHeader className='p-4 pb-0'>
                        ...
                        <CardDescription>
                            You are burning an average of 754 calories per day.
                            Good job!
                        </CardDescription>
                    </CardHeader>
